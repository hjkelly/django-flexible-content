...
class BaseItem(models.Model):
    ...
    def get_form_class(self):
        ...
        if form_class is None:
            ...
            form_class = type(name, (ModelForm,),
                              {'Meta': type('Meta', {'model': self.__class__}))
    ...
    def get_type_slug(self):
        ...
        if slug is None:
            slug = self.__model__.__name__.lower()

        return slug

    def get_template_name(self):
        return 'flexible_content/{}.html'.format(self.get_type_slug())
...
class ContentArea(models.Model):
    ...
    def get_rendered_content(self):
        ...
        if self.rendered_content is None:
            rendered_items = [i.get_rendered()
                              for i in self.get_content_items()]
